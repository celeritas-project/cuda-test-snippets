...
//--------------------- .text._Z8cbrt_powPd       --------------------------
	.section	.text._Z8cbrt_powPd,"ax",@progbits
	.sectioninfo	@"SHI_REGISTERS=24"
	.align	128
        .global         _Z8cbrt_powPd
        .type           _Z8cbrt_powPd,@function
        .size           _Z8cbrt_powPd,(.L_x_106 - _Z8cbrt_powPd)
        .other          _Z8cbrt_powPd,@"STO_CUDA_ENTRY STV_DEFAULT"
_Z8cbrt_powPd:
.text._Z8cbrt_powPd:
	//## File "/home/s3j/.local/src/cuda-test-snippets/pow/cbrt-pow.cu", line 3
        ...
        /*0080*/                   MOV R16, R16 ;
        /*0090*/                   MOV R2, R2 ;
	//## File "/home/s3j/.local/src/cuda-test-snippets/pow/cbrt-pow.cu", line 5
        ...
        /*0180*/                   MOV R4, R6 ;
        /*0190*/                   MOV R5, R7 ;
        /*01a0*/                   MOV R8, 0x55555555 ;
        /*01b0*/                   MOV R9, 0x3fd55555 ;
        /*01c0*/                   MOV R6, R8 ;
        /*01d0*/                   MOV R7, R9 ;
        /*01e0*/                   MOV R4, R4 ;
        /*01f0*/                   MOV R5, R5 ;
        /*0200*/                   MOV R6, R6 ;
        /*0210*/                   MOV R7, R7 ;
        /*0220*/                   MOV R20, 32@lo((_Z8cbrt_powPd + .L_x_0@srel)) ;
        /*0230*/                   MOV R21, 32@hi((_Z8cbrt_powPd + .L_x_0@srel)) ;
        /*0240*/                   CALL.ABS.NOINC `(pow) ;
.L_x_0:
        /*0250*/                   MOV R4, R4 ;
        /*0260*/                   MOV R5, R5 ;
        /*0270*/                   S2R R0, SR_TID.X ;
        /*0280*/                   MOV R0, R0 ;
        /*0290*/                   MOV R0, R0 ;
        /*02a0*/                   MOV R0, R0 ;
        /*02b0*/                   MOV R3, RZ ;
        /*02c0*/                   SHF.L.U64.HI R3, R0, 0x3, R3 ;
        /*02d0*/                   SHF.L.U32 R0, R0, 0x3, RZ ;
        /*02e0*/                   IADD3 R16, P0, R16, R0, RZ ;
        /*02f0*/                   IADD3.X R3, R2, R3, RZ, P0, !PT ;
        /*0300*/                   MOV R2, R16 ;
        /*0310*/                   MOV R3, R3 ;
        /*0320*/                   MOV R2, R2 ;
        /*0330*/                   MOV R3, R3 ;
        /*0340*/                   ST.E.64.SYS [R2], R4 ;
	//## File "/home/s3j/.local/src/cuda-test-snippets/pow/cbrt-pow.cu", line 6
        /*0350*/                   MEMBAR.SC.VC ;
        /*0360*/                   ERRBAR ;
        /*0370*/                   EXIT ;
        /*0380*/                   MEMBAR.SC.VC ;
...
.L_x_3:
        ...
        /*0430*/                   MOV R2, R12 ;
        /*0440*/                   MOV R20, 32@lo((pow + .L_x_1@srel)) ;
        /*0450*/                   MOV R21, 32@hi((pow + .L_x_1@srel)) ;
...
.text.__internal_accurate_pow:
        ...
        .size           __internal_accurate_pow,(.L_x_108 - __internal_accurate_pow)
