...
compile_size = 64bit
	...
	.headerflags    @"EF_CUDA_SM35 EF_CUDA_PTX_SM(EF_CUDA_SM35)"
        ...
        /*0058*/               @P0 EXIT;
        /*0060*/                   ISCADD R16.CC, R6, c[0x0][0x178], 0x3;
        /*0068*/                   MOV32I R0, 0x8;
        /*0070*/                   IMAD.HI.X R17, R6, R0, c[0x0][0x17c];
        /*0078*/                   ISCADD R2.CC, R6, c[0x0][0x1a8], 0x3;

        /*0088*/                   LD.E.64 R10, [R16];
        /*0090*/                   IMAD.HI.X R3, R6, R0, c[0x0][0x1ac];
        /*0098*/                   ISCADD R12.CC, R6, c[0x0][0x148], 0x3;
        /*00a0*/                   LD.E.64 R8, [R2];
        /*00a8*/                   IMAD.HI.X R13, R6, R0, c[0x0][0x14c];
        /*00b0*/                   LD.E.64 R14, [R12];
        /*00b8*/                   ISCADD R20.CC, R6, c[0x0][0x188], 0x3;

        /*00c8*/                   IMAD.HI.X R21, R6, R0, c[0x0][0x18c];
        /*00d0*/                   ISCADD R4.CC, R6, c[0x0][0x158], 0x3;
        /*00d8*/                   IMAD.HI.X R5, R6, R0, c[0x0][0x15c];
        /*00e0*/                   DFMA R8, R8, R10, R14;
        /*00e8*/                   ST.E.64 [R12], R8;
        /*00f0*/                   ISCADD R22.CC, R6, c[0x0][0x198], 0x3;
        /*00f8*/                   LD.E.64 R14, [R20];

        /*0108*/                   LD.E.64 R10, [R2];
        /*0110*/                   IMAD.HI.X R23, R6, R0, c[0x0][0x19c];
        /*0118*/                   LD.E.64 R16, [R4];
        /*0120*/                   ISCADD R18.CC, R6, c[0x0][0x168], 0x3;
        /*0128*/                   IMAD.HI.X R19, R6, R0, c[0x0][0x16c];
